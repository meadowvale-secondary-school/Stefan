...
//print("The value of foo is \(foo)")
// because foo is a local variable and cannot be called outside the curly braces
/*:
...
// both print statement compile because x is a global variable and can be accesedd within or outside any curly braces
/*:
...
greeting(greeting: "Hola", name: "Stefan")
/*:
...
let fordFocus=Car(make: "Ford", model: "Focus", year: 2003)
print(fordFocus.make,fordFocus.model,fordFocus.year)
