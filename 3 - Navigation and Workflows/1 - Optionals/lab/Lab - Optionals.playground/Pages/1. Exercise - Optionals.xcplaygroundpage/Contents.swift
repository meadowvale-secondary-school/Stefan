...
*/
let userInputAge:String="78"
let userAge: Int?=Int(userInputAge)
print(userAge)
print("user's age is value nil because 34e cannot be converted to an int therefore it recieves the value of nil")
/*:
